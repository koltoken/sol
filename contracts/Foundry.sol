...
contract Foundry is IFoundry, Ownable {
  ...
  function createApp(
    ...
    address market = IMarketFactory(marketFactory).create(appId, FEE_DENOMINATOR, TOTAL_PERCENT, _curve, _buySellFee);
    ...
    emit CreateApp(appId, _name, _owner, _operator, _curve, _buySellFee, publicNFT, mortgageNFT, market, msg.sender);
  }
